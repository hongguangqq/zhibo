...
public class AudienceVoiceActivity extends BaseMCVActivity implements AVChatStateObserverLite {
    ...
    private void initSetting(){
        ...
        AVChatManager.getInstance().joinRoom2(ScannerManager.mMeetingName, AVChatType.VIDEO, new AVChatCallback<AVChatData>() {
            @Override
...
//            });
        ...
        if (activity != null) {
            isPause = true;
            activity.finish();
            IntentHelper.OpenEndCallActivity(AudienceVoiceActivity.this,false);
        }
    ...
    private void doCompletelyFinish() {
        ...
        getHandler().postDelayed(new Runnable() {
            @Override
            public void run() {
                releaseRtc(AudienceVoiceActivity.this,true,true);
